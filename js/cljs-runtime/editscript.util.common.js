...
var vec__15707 = cljs.core.get.cljs$core$IFn$_invoke$arity$3(fp,(k - (1)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(-1),cljs.core.PersistentVector.EMPTY], null));
var dk_1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15707,(0),null);
var vk_1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15707,(1),null);
var dk_1__$1 = (dk_1 + (1));
var vec__15710 = cljs.core.get.cljs$core$IFn$_invoke$arity$3(fp,(k + (1)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(-1),cljs.core.PersistentVector.EMPTY], null));
var dk_PLUS_1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15710,(0),null);
var vk_PLUS_1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15710,(1),null);
var x = (function (){var x__5087__auto__ = dk_1__$1;
var y__5088__auto__ = dk_PLUS_1;
...
if(cljs.core.truth_((function (){var and__5000__auto__ = timeout;
...
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__15706_SHARP_,(1));
...
var vec__15717 = cljs.core.split_with((function (p1__15716_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__15716_SHARP_,m);
}),coll);
var ms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15717,(0),null);
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15717,(1),null);
var mc = cljs.core.count(ms);
var pc = cljs.core.count(ps);
var delta = Math.abs((mc - pc));
var rs = cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((function (){var x__5087__auto__ = mc;
var y__5088__auto__ = pc;
return ((x__5087__auto__ > y__5088__auto__) ? x__5087__auto__ : y__5088__auto__);
...
editscript.util.common.vec_edits = (function editscript$util$common$vec_edits(a,b,p__15722){
var map__15723 = p__15722;
var map__15723__$1 = cljs.core.__destructure_map(map__15723);
var vec_timeout = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15723__$1,new cljs.core.Keyword(null,"vec-timeout","vec-timeout",1050752333),(1000));
...
var s = (function (){var G__15733 = b;
var G__15734 = cljs.core.deref(i);
var G__15735 = (cljs.core.deref(i) + c);
return (sf.cljs$core$IFn$_invoke$arity$3 ? sf.cljs$core$IFn$_invoke$arity$3(G__15733,G__15734,G__15735) : sf.call(null, G__15733,G__15734,G__15735));
})();
...
var s = (function (){var G__15736 = b;
var G__15737 = cljs.core.deref(i);
var G__15738 = (cljs.core.deref(i) + c);
return (sf.cljs$core$IFn$_invoke$arity$3 ? sf.cljs$core$IFn$_invoke$arity$3(G__15736,G__15737,G__15738) : sf.call(null, G__15736,G__15737,G__15738));
})();
i.cljs$core$IVolatile$_vreset_BANG_$arity$2(null, cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,c)(i.cljs$core$IDeref$_deref$arity$1(null, )));
...
editscript.util.common.diff_str = (function editscript$util$common$diff_str(script,path,a,b,p__15740){
var map__15741 = p__15740;
var map__15741__$1 = cljs.core.__destructure_map(map__15741);
var opts = map__15741__$1;
var str_change_limit = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15741__$1,new cljs.core.Keyword(null,"str-change-limit","str-change-limit",529572329),0.2);
var str_diff = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15741__$1,new cljs.core.Keyword(null,"str-diff","str-diff",1239614806));
