...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_13583 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_13583(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_13596 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_13596(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_13604 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_13604(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_13607 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_13607(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13609 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13609(runtime,input,callback);
}
});
...
shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__13562,callback){
var map__13563 = p__13562;
var map__13563__$1 = cljs.core.__destructure_map(map__13563);
var input = map__13563__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13563__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13563__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
