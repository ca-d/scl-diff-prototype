...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_14005 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_14005(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_14007 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_14007(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_14013 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_14013(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_14021 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_14021(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_14027 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_14027(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_14033 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_14033(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__13990,callback){
var map__13991 = p__13990;
var map__13991__$1 = cljs.core.__destructure_map(map__13991);
var input = map__13991__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13991__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13991__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
