...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_11588 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_11588(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_11591 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_11591(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_11596 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_11596(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_11599 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_11599(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_11605 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_11605(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_11608 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_11608(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_11618 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_11618(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_11625 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_11625(b);
}
});
...
var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_11636 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_11636(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_11644 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_11644(b);
}
});
