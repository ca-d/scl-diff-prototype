...
var G__20411 = (root.arr[(slc - (1))]);
var G__20412 = (shift - (5));
var G__20413 = (((rngs[(31)]) - (rngs[(30)])) + (32));
root = G__20411;
shift = G__20412;
cnt = G__20413;
continue;
...
if((!(r_QMARK_))){
var rngs_20433 = clojure.core.rrb_vector.nodes.node_ranges(parent);
var rng0_20434 = (rngs_20433[(0)]);
var new_rngs_20435 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
var lim_20436 = (rngs_20433[(32)]);
cljs.core.array_copy(rngs_20433,(1),new_rngs_20435,(0),(lim_20436 - (1)));

var i_20440 = (0);
while(true){
if((i_20440 < lim_20436)){
(new_rngs_20435[i_20440] = ((new_rngs_20435[i_20440]) - rng0_20434));
...
(new_rngs_20435[(32)] = ((rngs_20433[(32)]) - (1)));

(new_rngs_20435[((rngs_20433[(32)]) - (1))] = (0));

(new_arr[(32)] = new_rngs_20435);
} else {
}
...
while(true){
if((i_20447 <= li)){
(new_rngs[i_20447] = ((new_rngs[(i_20447 - (1))]) + step));
...
while(true){
if((i_20453 <= li)){
(new_rngs[i_20453] = ((rngs[i_20453]) - d));

var G__20454 = (i_20453 + (1));
i_20453 = G__20454;
continue;
} else {
}
...
while(true){
if((j_20456 <= i)){
(rngs[j_20456] = r_20457);

var G__20458 = (j_20456 + (1));
var G__20459 = (r_20457 + step);
j_20456 = G__20458;
r_20457 = G__20459;
continue;
} else {
...
var rngs = (((!(reg_QMARK_)))?(function (){var G__20354 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
(G__20354[(0)] = node.arr.length);
...
var arr_20462__$1 = arr;
var shift_20463__$1 = shift;
while(true){
if((shift_20463__$1 === (5))){
if((!(reg_QMARK_))){
(arr_20462__$1[(32)] = rngs);
} else {
}

(arr_20462__$1[(0)] = node);
} else {
var a_20464 = (new Array(len));
var e_20465 = cljs.core.__GT_VectorNode(null,a_20464);
(arr_20462__$1[(0)] = e_20465);
...
var G__20466 = a_20464;
var G__20467 = (shift_20463__$1 - (5));
arr_20462__$1 = G__20466;
shift_20463__$1 = G__20467;
continue;
}
break;
}
...
var cret = (((shift === (5)))?cljs.core.__GT_VectorNode(null,tail):(function (){var G__20366 = (arr[(li - (1))]);
var G__20367 = (shift - (5));
var G__20368 = ((clojure.core.rrb_vector.nodes.regular_QMARK_(node))?cljs.core.mod(cnt,((1) << shift)):(function (){var li__$1 = ((rngs[(32)]) - (1));
if((li__$1 > (0))){
...
var G__20369 = tail;
return (clojure.core.rrb_vector.nodes.fold_tail.cljs$core$IFn$_invoke$arity$4 ? clojure.core.rrb_vector.nodes.fold_tail.cljs$core$IFn$_invoke$arity$4(G__20366,G__20367,G__20368,G__20369) : clojure.core.rrb_vector.nodes.fold_tail.call(null, G__20366,G__20367,G__20368,G__20369));
})());
