...
var ensure_set_11909 = taoensso.truss.impl.ensure_set;
taoensso.truss.impl.ks_EQ_ = (function taoensso$truss$impl$ks_EQ_(ks,m){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.set(cljs.core.keys(m)),(ensure_set_11909.cljs$core$IFn$_invoke$arity$1 ? ensure_set_11909.cljs$core$IFn$_invoke$arity$1(ks) : ensure_set_11909.call(null, ks)));
});

taoensso.truss.impl.ks_LT__EQ_ = (function taoensso$truss$impl$ks_LT__EQ_(ks,m){
return clojure.set.subset_QMARK_(cljs.core.set(cljs.core.keys(m)),(ensure_set_11909.cljs$core$IFn$_invoke$arity$1 ? ensure_set_11909.cljs$core$IFn$_invoke$arity$1(ks) : ensure_set_11909.call(null, ks)));
});

taoensso.truss.impl.ks_GT__EQ_ = (function taoensso$truss$impl$ks_GT__EQ_(ks,m){
return clojure.set.superset_QMARK_(cljs.core.set(cljs.core.keys(m)),(ensure_set_11909.cljs$core$IFn$_invoke$arity$1 ? ensure_set_11909.cljs$core$IFn$_invoke$arity$1(ks) : ensure_set_11909.call(null, ks)));
});

taoensso.truss.impl.ks_nnil_QMARK_ = (function taoensso$truss$impl$ks_nnil_QMARK_(ks,m){
return taoensso.truss.impl.revery_QMARK_((function (p1__11885_SHARP_){
return (!((cljs.core.get.cljs$core$IFn$_invoke$arity$2(m,p1__11885_SHARP_) == null)));
}),ks);
});
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__11898_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("clojure.core",p1__11898_SHARP_);
}),names)),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__11899_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("cljs.core",p1__11899_SHARP_);
}),names));
})();
...
var G__11903 = (new cljs.core.Delay((function (){
...
}catch (e11904){if((e11904 instanceof Error)){
var e = e11904;
...
return (error_fn.cljs$core$IFn$_invoke$arity$1 ? error_fn.cljs$core$IFn$_invoke$arity$1(G__11903) : error_fn.call(null, G__11903));
} else {
return null;
}
});
