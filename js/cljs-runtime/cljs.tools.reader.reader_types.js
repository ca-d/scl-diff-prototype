...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_21560 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_21560(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_21570 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_21570(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_21579 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_21579(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21584 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21584(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21594 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21594(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21597 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21597(reader);
}
});
...
var G__21709 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__21710 = s.append(c);
c = G__21709;
s = G__21710;
continue;
}
